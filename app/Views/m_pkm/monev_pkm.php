<?= $this->extend('m_pkm/templates/tem_pkm');  ?>

<?= $this->section('content_pkm');  ?>
<!-- Page Wrapper -->
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url("/dashboard");  ?>">
            ...
            <div class="sidebar-brand-text mx-2">Monev PkM</div>
        </a>
        ...
        <!-- Nav Item - PKM -->
        <li class="nav-item">
            <a class="nav-link" href="<?= base_url("/monev_pkm");  ?>">
                <i class="icon fa fa-users"></i>
                <span>Pengabdian kepada Masyarakat</span></a>
        </li>
        <!-- Divider -->
        <hr class="sidebar-divider">
        <div class="sidebar-heading">Prodi/Fakultas</div>
        <!-- Nav Item - Pengabdian Kepada Masyarakat -->
        <li class="nav-item">
            ...
            <div class="container-fluid">
                ...
                <div class="d-flex pl-0 mb-3">
                    ...
                    <div>
                        ...
                        <p class="mg-b-0">Olah Data PkM</p>
                    </div>
                </div>
                                ...
                                <table class="table table-responsive" id="dataTable" width="100%" cellspacing="0">
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th>Prodi</th>
                                            <th>Peta Jalan PkM</th>
                                            <th>Sesuai Jalan PkM</th>
                                            <th>Bukti Evaluasi PkM</th>
                                            <th>Tindak Lanjut Evaluasi PkM</th>
                                    ...
                                    <tbody><?php $i = 1;  ?>
                                        <?php foreach ($penel as $row) : ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="<?= base_url("/view_pdf_evaluasipkm/" . $row['id']);  ?>"><i class="fa fa-file-pdf fa-2x btn-danger"> </i></a><br>
                                                    <?= $row['evaluasi_pkm'];  ?>

                                                </td>

                                                <td class="text-center">
                                                    <a href="<?= base_url("/view_pdf_evaluasipkm_tindaklanjut/" . $row['id']);  ?>"><i class="fa fa-file-pdf fa-2x btn-danger"> </i></a><br>
                                                    <?= $row['evaluasi_pkm_tindaklanjut'];  ?>

                                                </td>
                                                <td>
                                                    <button type="button" data-toggle="modal" data-target="#modalUbah" class="btn btn-sm btn-warning" id='btn-panel' data-id="<?= $row['id'];  ?> " data-tahun="<?= $row['tahun'];  ?>" data-judulkegiatan="<?= $row['judulkegiatan'];  ?>" data-namamahasiswa="<?= $row['namamahasiswa'];  ?>" data-namadosen="<?= $row['namadosen'];  ?>"><i class="fas fa-edit "> Edit </i></button>
                        ...
                        <div class="modal-body">
                            <form action="<?= base_url("backend/tambah_data2");  ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-0">
                                    ...
                                    <input type="text" name="judulkegiatan" id="judulkegiatan" class="form-control" placeholder="Masukan Judul Kegiatan">
                                </div>
                                <div class="form-group mb-0">
                                    <label for="">Nama Mahasiswa</label>
                                    <input type="text" name="namahasiswa" id="namahasiswa" class="form-control" placeholder="Masukan Namama hasiswa">
                                </div>
                                <div class="form-group mb-0">
                                ...
                                <div class="form-group mb-0">
                                    <label for="">Peta Jalan PkM</label>
                                ...
                                <div class="form-group mb-0">
                                    <label for="">PkM Sesuai Peta Jalan </label>
                                    <div class="custom-file">
                                ...
                                <div class="form-group mb-0">
                                    <label for="">Bukti Evaluasi PkM</label>
                                    <div class="custom-file">

                                        <input type="file" id="evaluasi_pkm" name="evaluasi_pkm">
                                ...
                                <div class="form-group mb-0">
                                    <label for="">Tindak Lanjut Evaluasi PkM</label>
                                    <div class="custom-file">

                                        <input type="file" id="evaluasi_pkm_tindaklanjut" name="evaluasi_pkm_tindaklanjut">

                                        <label class="text-danger">*File boleh kosong & harus format pdf</label>
                                    </div>
                                </div>
                        </div>
                        <div class="modal-footer">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="<?= base_url("backend/ubah_data2");  ?>" method="post">
                                ...
                                <div class="form-group mb-0">
                                    <label for="">Judul Kegiatan</label>
                                    <input type="text" name="ubah_judulkegiatan" id="ubah_judulkegiatan" class="form-control" placeholder="Masukan Judul Kegiatan" value="<?= $row['judulkegiatan'];  ?>">
                                </div>
                                <div class="form-group mb-0">
                                    <label for="">Nama Mahasiswa</label>
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright <?= date('Y');  ?>&copy; Monitoring dan Evaluasi Pengabdian kepada Masyarakat</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
